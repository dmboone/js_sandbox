...
// ES6 MAPS = key-value pairs - can use ANY type as a key or value
// const map1 = new Map();
...
// console.log(set1.has({name: 'John'})); // returns false because objects are reference objects stored in the stack
